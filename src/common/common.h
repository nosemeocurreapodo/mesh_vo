...
inline Eigen::Vector3f fromRayIdepthToVertex(Eigen::Vector3f rayIdepth)
{
...
inline Eigen::Vector3f arrayToEigen(std::array<float, 3> point)
{
    return Eigen::Vector3f(point[0], point[1], point[2]);
}

inline std::array<float, 3> eigenToArray(Eigen::Vector3f point)
{
