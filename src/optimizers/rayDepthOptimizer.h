...
class RayDepthOptimizer : public BaseOptimizer<RayDepthOptimizer,
                                             Matx<float>,
                                             Vecx<float>,
                                             DenseLinearProblemx,
                                             Solverx<float>>
{
public:
    using Base = BaseOptimizer<RayDepthOptimizer,
                               Matx<float>,
                               Vecx<float>,
                               DenseLinearProblemx,
                               Solverx<float>>;

    RayDepthOptimizer(int w, int h, bool printlog = false)
        : Base(w, h, printlog),
    ...
    void reset(const std::vector<Frame> &frames, const KeyFrame &kframe, DenseLinearProblemx &problem, Solverx<float> &solver)
    {
