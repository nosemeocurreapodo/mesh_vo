...
{
	DenseLinearProblem2<6> problem = compute_problem_(frame, kframe, cam, lvl);
...
DenseLinearProblem2 PoseOptimizer::compute_problem_(Frame &frame, KeyFrame &kframe, Camera &cam, int lvl)
{
