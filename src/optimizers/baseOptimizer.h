...
protected:
    Error compute_error_(Frame &frame, KeyFrame &kframe, Camera &cam, int in_lvl, int out_lvl)
    {
        ...
        residualrenderer_.Render(kframe.mesh(), frame.local_pose(), frame.local_vel(), frame.local_exposure(), cam, 30, in_lvl, out_lvl, kframe.frame().image(), frame.image(), r_texture_);
